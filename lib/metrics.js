const UpdateMetricState = require('./update-metric-state')

module.exports = class Metrics {
    constructor(str){
        this.metricsState = {}
        this.UpdateMetricState = new UpdateMetricState()
    }
    ...
    metrics({ circuit, metrics, circuitMetrics, run }){
        ...
        this.UpdateMetricState.trafficVolume(json, (totalCount - json.previousCount), percentileCount)
